package com.liulei.shiro.config;

import com.liulei.shiro.mgt.SessionManager;
import com.liulei.shiro.realm.ShiroRealm;
import com.liulei.shiro.util.ShiroCacheManager;
...
public class ShiroConfig {
    ...
    @Bean
    public ShiroRealm shiroRealma(RedisTemplate redisTemplate) {
    ...
    public SecurityManager securityManager(RedisTemplate redisTemplate) {
        ...
        securityManager.setRealm(shiroRealma(redisTemplate));

<template>
    <div>
        <header>
            <div class='header'>
                <img src="static/img/blog/header.jpg" alt="RUNZE个人网站-RUNZE个人博客-RUNZE"/>
                <div class='navbar-container'>
                    <ul>
                        ...
                        <div class='h-sep'></div>
                        <li>
                            <router-link to="/blog/study">学习笔记</router-link>
                        </li>
                        <div class='h-sep'></div>
                        <li>
                            <router-link to="/blog/essay">心情随笔</router-link>
                        </li>
                        <div class='h-sep'></div>
                        <li>
                            <router-link to="/blog/func">扩展功能</router-link>
                        </li>
                        <div class='h-sep'></div>
                        <li>
                            <router-link to="/blog/board">留言板</router-link>
                        </li>
                        <div class='h-sep'></div>
                        <li>
